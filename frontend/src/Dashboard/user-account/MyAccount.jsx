        ...
        <div className="pb-[50px] px-[30px] rounded-md">
          ...
          <div className="mt-[50px] md:mt-[100px]">
            <button
              ...
              className="w-full bg-[#181A1E] pt-3 text-[16px] leading-7 rounded-md text-white"
            >
              Logout
            </button>
            <button className="w-full bg-red-600 mt-4 pt-3 text-[16px] leading-7 rounded-md text-white">
              Delete account
            </button>
          </div>
        </div>
